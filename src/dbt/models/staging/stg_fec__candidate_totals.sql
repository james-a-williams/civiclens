select
    ...
    individual_unitemized_contributions::decimal(18, 2)             as individual_unitemized_contributions,
    -- PAC/committee money is the primary COI signal
    other_political_committee_contributions::decimal(18, 2)         as pac_contributions,
    political_party_committee_contributions::decimal(18, 2)         as party_contributions,
    candidate_contribution::decimal(18, 2)                          as candidate_self_funding,
